...
class UserRegisterFormTest extends BrowserTestBase {
  ...
  protected function setUp(): void {
    ...
    // Change site configuration to allow user registration by visitors without administrator approval.
  ...
  public function testUserRegistrationForm() {
    ...
    // Check that the form cannot be submitted and an error message is displayed.
