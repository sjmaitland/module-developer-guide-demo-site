 ...
 * 
 *  @group anytown
 *  @group coversClass \Drupal\anytown\Plugin\Validation\Constraint\UserNameConstraint
...
class UsernameConstraintTest extends KernelTestBase {
  ...
  protected function setUp(): void {
    ...
    // Install required schemas for the User module. This will create the database tables required when creating a new user entity.
    $this->installEntitySchema('user');

    // You can also install configuration if necessary. $this->installConfig(['user']);.
  }
